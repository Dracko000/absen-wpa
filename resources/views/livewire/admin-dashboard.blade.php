                                ...
                                <li class="py-3">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                                            ...
                                            <a href="{{ route('admin.qr.show') }}" class="inline-flex items-center px-2.5 py-1 border border-transparent text-xs font-medium rounded-full shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-700 dark:hover:bg-indigo-800 transition-colors">
                                                <svg class="h-3.5 w-3.5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
